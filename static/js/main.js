...
Kilter.renderResponsiveTable = function() {
  $('td.tab-active').attr('colspan', 3);
}

Kilter.disableResponsiveTable = function() {
  $('td').not('.centered').attr('colspan', "");
}

Kilter.parseScheduleJson = function (data, eventType, divContainer) {
